...
### Event file notes:
1. Adding hit location is in progress of being added; I do not have the means to automatically determine the position of batted balls in respect to stadium shapes/sizes, so judgments are manual.
...
### Roster note:
Rosters for teams still playing are shown with 29-30 people in each, but there is actually some nuance here. Active rosters are around 17 people max, but players drafted by teams are restricted to playing for those teams in cases of, for example, injury. All drafted players are included as part of a sort of inactive roster even if they are not active.
